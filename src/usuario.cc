...
bool Estudiante::SetTutor(const Tutor& tutor){
	tutor_asignado_=tutor;
	return true;
}
...
Estudiante::Estudiante(const std::string& id, const std::string& nombre, const std::string& email, const std::string& informacion_academica, const std::string& alojamiento, const std::string& progreso){
	SetId(id);
	SetNombre(nombre);
	SetEmail(email);
...
Tutor::Tutor(const std::string& id, const std::string& nombre, const std::string& email, const std::string& facultad, const std::string& horario){
	SetId(id);
	SetNombre(nombre);
	SetEmail(email);
...
Coordinador::Coordinador(const std::string& id, const std::string& nombre, const std::string& email, const std::string& facultad, const std::string& responsabilidades){
	SetId(id);
	SetNombre(nombre);
	SetEmail(email);
	SetFacultad(facultad);
